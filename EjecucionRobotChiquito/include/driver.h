...
void controlMotoresColgado() {
    if (Controller1.ButtonX.pressing()) {
        MotoresColgado.spin(forward, 100, percent);
        /* MotorColgado1.spin(forward, 100, percent);
        MotorColgado2.spin(forward, 100, percent);
        MotorColgado3.spin(forward, 100, percent);
        MotorColgado4.spin(forward, 100, percent); */
    } else if (Controller1.ButtonY.pressing()) {
        MotoresColgado.spin(reverse, 100, percent);
        /* MotorColgado1.spin(reverse, 100, percent);
        MotorColgado2.spin(reverse, 100, percent);
        MotorColgado3.spin(reverse, 100, percent);
        MotorColgado4.spin(reverse, 100, percent); */
    } else {
        MotorColgado1.stop();
        MotorColgado2.stop();
        MotorColgado3.stop();
